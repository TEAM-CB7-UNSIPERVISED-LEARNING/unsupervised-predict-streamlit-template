...
def main():
    ...
    page_options = ["Search for a movie","Welcome","About","Recommender System","Solution Overview","Team Profile","Data analysis", "Contact Details","Information","Datasets","Glossary","Reviews","history"]
