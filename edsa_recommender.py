...
def main():
    ...
    page_options = ["Search for a movie","welcome","About","Recommender System","Solution Overview","Team Profile","Data analysis", "Contact Details","Information","Datasets","Glossary","map location","Reviews"]
    ...
    if page_selection == 'Reviews':
        ...
        st.info('''<span style="color:blue"> **Help us improve this app by rating it. Tell us how to give you a better user experience.** </span>''', unsafe_allow_html=True)
